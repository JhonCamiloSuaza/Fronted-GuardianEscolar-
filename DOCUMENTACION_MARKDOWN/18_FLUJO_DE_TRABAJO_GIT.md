...
La historia se prepara como una carpeta independiente con su documentacion, configuracion y dependencias declaradas. Un commit recomendado para estos cambios es:

```text
feat(HU-12): improve child registration and date selection
```
